...
let PokemonController = class PokemonController {
    ...
    search(search, limit, offset, region) {
        return this.pokemonService.search(search, limit ? Number(limit) : undefined, offset ? Number(offset) : undefined, region);
    }
    getById(nameOrId) {
...
], PokemonController.prototype, "search", null);
__decorate([
    (0, common_1.Get)(':nameOrId'),
    __param(0, (0, common_1.Param)('nameOrId')),
    __metadata("design:type", Function),
    __metadata("design:paramtypes", [String]),
    __metadata("design:returntype", void 0)
], PokemonController.prototype, "getById", null);
